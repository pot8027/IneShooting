...
public class PlayerShot : TokenController
{
    /// <summary>
    /// プレハブ名
    /// </summary>
    private static readonly string PREFUB_NAME = "PlayerShot";

    /// <summary>
    /// インスタンスリスト
    /// </summary>
    private static TokenManager<PlayerShot> _parent = null;
    ...
    {
        _parent = new TokenManager<PlayerShot>(PREFUB_NAME, size);
    }
    ...
    public static PlayerShot Add(float x, float y, float direction, float speed)
    {
        if (_parent == null)
        {
            return null;
